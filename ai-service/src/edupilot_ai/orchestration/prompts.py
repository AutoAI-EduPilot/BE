...
def plan_messages(
    ...
    *,
    ...
    plan_instruction = (
        ...
        "larger section and even when its extracted text is short; judge semantic importance, "
        "not page length, outline-section boundaries, or precomputed quiz checkpoints. Favor "
        "the prompt when a beginner should verify a newly introduced premise before later "
        "derivations build on it. Do not add it merely because a page was explained, at "
        "title/table-of-contents/transition pages, or when the page only continues an "
        "unfinished explanation without an independently answerable learning point. Learner "
